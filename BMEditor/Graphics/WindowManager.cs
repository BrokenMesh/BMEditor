...
namespace BMEditor.Graphics {
    public class WindowManager 
    {
        ...
        private static Callback sizeCallback;
        ...
        public static unsafe void CreateWindow(int _width, int _height, string _title) {
            ...
            // GLfw Callbacks
            Glfw.SetWindowSizeCallback(window, (Window _window, int _width, int _height) => {
                windowSize = new Vector2(_width, _height);
                glViewport(0, 0, _width, _height);
        ...
        public static void SetWindowSizeCallback(Callback _sizeCallback) {
            sizeCallback = _sizeCallback;
        }

        public static void ClearWindowBuffer() {
